 ...
 * @author Julian
 */
public class RenovarLicencia2 extends javax.swing.JFrame {
     ...
     */
    public RenovarLicencia2(Titular tit, String dni, String ciudad, String calle, String numero, String piso, String departamento) {
        this.tit = tit;
        this.dni = dni;
        this.ciudad = ciudad;
        this.calle = calle;
    ...
    private void imprimirButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_imprimirButtonActionPerformed
        try {
            ...
            Logger.getLogger(RenovarLicencia2.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RenovarLicencia2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RenovarLicencia2().setVisible(true);
            }
        });
    }
